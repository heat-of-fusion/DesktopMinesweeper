...
from GridDistanceSearcher import grid_search
from MinesweeperUtils import generate_map, bfs
...
class GUIBlock():
    def __init__(self, blockW, blockH, blockPosX, blockPosY, icon_dict, value, idxX, idxY, vailed = True):
        ...
        # print(f'Screen Width: {self.screenW}, Screen Height: {self.screenH}')
...
print(f'Original: resX: {resX}, resY: {resY}')
